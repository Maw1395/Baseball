...
INNINGS={}
stmt = "select Game_Number, Pitcher, outs, max(inning), outcome from PlateAppearance group by game_number, pitcher, outs"
...
plt.bar(inningslist, outlist,color='black', align='center')
plt.xlabel("Inning")
plt.ylabel("Pulled")
...
plt.title("2000-2009 Pitchers Pulled By Inning and Outs")
